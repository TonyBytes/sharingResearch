...
<head>
    ...
    <script src="<?php echo e(asset('app.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('controller.js')); ?>" type="text/javascript"></script>
    
    <link href="<?php echo e(asset('link-preview.css')); ?>" rel="stylesheet">
    <script src="<?php echo e(asset('link-preview.js')); ?>" type="text/javascript"></script>
